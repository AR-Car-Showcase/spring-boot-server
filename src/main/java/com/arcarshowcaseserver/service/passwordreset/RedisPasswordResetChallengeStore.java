...
@Component
@ConditionalOnProperty(prefix = "app.password-reset", name = "store-mode", havingValue = "REDIS")
public class RedisPasswordResetChallengeStore implements PasswordResetChallengeStore {
    ...
    public RedisPasswordResetChallengeStore(StringRedisTemplate redisTemplate,
    ...
    private PasswordResetChallengeState fromHash(String email, Map<Object, Object> data) {
        PasswordResetChallengeState state = new PasswordResetChallengeState();
    ...
    private String prefix() {
        String value = properties.getRedisKeyPrefix();
        return value == null || value.isBlank() ? "security:password-reset" : value;
    }
